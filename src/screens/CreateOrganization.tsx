    ...
    <section className="content-stack page-enter">
      ...
      <div className="two-column">
        <div className="panel form-panel">
          <label>Nome da organização<input value={name} onChange={(event) => setName(event.target.value)} /></label>
          ...
          <label>Meta financeira<input value={goal} onChange={(event) => setGoal(event.target.value)} inputMode="numeric" /></label>
